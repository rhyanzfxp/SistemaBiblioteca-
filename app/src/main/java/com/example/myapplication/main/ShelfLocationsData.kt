...
val areasTerreo: Map<String, Area> = mapOf(
    ...
    "0B" to Area("0B", 8f, 35f, 442f, 30f),
    "0C" to Area("0C", 8f, 72f, 442f, 30f),
    "0D" to Area("0D", 8f, 99f, 442f, 30f),
    "0E" to Area("0E", 8f, 136f, 442f, 30f),
    "0F" to Area("0F", 8f, 173f, 442f, 30f),
    "0G" to Area("0G", 8f, 200f, 442f, 30f),
    "0H" to Area("0H", 8f, 230f, 442f, 30f),
    "0I" to Area("0I", 8f, 270f, 442f, 30f),
    "0J" to Area("0J", 8f, 310f, 442f, 30f),
    "0K" to Area("0K", 8f, 340f, 442f, 30f),
    "0L" to Area("0L", 8f, 375f, 442f, 30f),
    "0M" to Area("0M", 8f, 405f, 442f, 30f),
    "0N" to Area("0N", 8f, 435f, 442f, 30f),
    "0O" to Area("0O", 8f, 470f, 442f, 30f),
    "0P" to Area("0P", 8f, 505f, 442f, 30f),
    "0Q" to Area("0Q", 8f, 535f, 442f, 30f),
    "0R" to Area("0R", 8f, 590f, 245f, 30f),
    "0S" to Area("0S", 8f, 620f, 225f, 30f),
    "0T" to Area("0T", 8f, 660f, 200f, 30f),
    "0U" to Area("0U", 490f, 8f, 126f, 30f),
    "0V" to Area("0V", 490f, 45f, 126f, 30f),
    "0W" to Area("0W", 490f, 82f, 126f, 30f),
    "0X" to Area("0X", 490f, 113f, 126f, 30f),
    "0Y" to Area("0Y", 490f, 146f, 126f, 30f),
    "0Z" to Area("0Z", 490f, 180f, 126f, 30f),
    "0AA" to Area("0AA", 490f, 215f, 126f, 30f),
    "0AB" to Area("0AB", 490f, 240f, 126f, 30f),
    "0AC" to Area("0AC", 490f, 270f, 126f, 30f),
    "0AD" to Area("0AD", 490f, 310f, 126f, 30f),
    "0AE" to Area("0AE", 490f, 340f, 126f, 30f),
    "0AF" to Area("0AF", 490f, 370f, 126f, 30f),
    "0AG" to Area("0AG", 490f, 410f, 126f, 30f),
    "0AH" to Area("0AH", 490f, 440f, 126f, 30f),
    "0AI" to Area("0AI", 490f, 480f, 106f, 30f),
    "0AJ" to Area("0AJ", 490f, 510f, 106f, 30f),
    "0AK" to Area("0AK", 490f, 540f, 106f, 30f),
    "0AL" to Area("0AL", 490f, 570f, 106f, 30f),
    "0AM" to Area("0AM", 490f, 600f, 106f, 30f),
)
